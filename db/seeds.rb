...
note6 = Note.create!(content: 'recruiter kept calling me', job: job1)
note7 = Note.create!(content: 'hiring manager requested portfolio', job: job4)
note8 = Note.create!(content: 'coding challenge is a take home one', job: job4)
